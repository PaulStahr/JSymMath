...
{   
    ...
    public:
        ...
        transformation_iterator& operator--(){--_iter; return *this;}  
        transformation_iterator operator--(int){transformation_iterator tmp(*this); --_iter; return tmp;}
        bool operator==(transformation_iterator<InputIter, Func> const & other) const{return _iter == other._iter && _f == other._f;}
        size_t operator-(transformation_iterator const & other) const{return _iter - other._iter;}
    };
