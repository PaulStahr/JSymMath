...
public class TransformConversion {
    ...
    public static void copy(Matrix3x2d in, AffineTransform out) {out.setTransform(in.m00, in.m10, in.m01, in.m11, in.m02, in.m12);}

    public static double distQ(AffineTransform at, Matrix3x2d mat3d) {
